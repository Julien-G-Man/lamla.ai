#!/bin/bash
# Image optimization script using Python PIL

echo "Creating image optimization script..."

cat > optimize_static_images.py << 'PYTHON_EOF'
#!/usr/bin/env python3
import os
...
echo "✅ Created optimize_static_images.py"
echo "🚀 Run with: python3 optimize_static_images.py"
